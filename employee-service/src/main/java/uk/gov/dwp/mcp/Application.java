...
public class Application {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Employee API").description("Operations for the Employee API")
				.version("1.0.0").contact("Samba Mitra <samba.mitra@accenture.com>")
				.termsOfServiceUrl("http://terms-of-service.url").licenseUrl("http://licenseurl").build();
	}
}
