...
public class ServiceControllerSecurityIT {
	...
	public void clientHttpRequestsAreRefused() {
		// Given
		final String requestEndpointUrl = getEmployeeServiceApiEndpoint();
		...
		// When
		this.restTemplate.getForEntity(httpRestEndpointUrl + "/1234", String.class);
	...
	public void clientHttpsAccessDeniedForBadCertificate()
		...
		// When
		this.restTemplate.getForEntity(getEmployeeServiceApiEndpoint() + "/1234", String.class);
